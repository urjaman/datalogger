...
/* N.B. Please dont go poking in these, these are in the API only to allow user allocation. */
/* No initialization is necessary before passing the pointer as *_in to the appropriate function. */
...
struct fat_fs_struct* fat_open(struct partition_struct* partition, struct fat_fs_struct *fs_in);
void fat_close(struct fat_fs_struct* fs);

struct fat_file_struct* fat_open_file(struct fat_fs_struct* fs, const struct fat_dir_entry_struct* dir_entry, struct fat_file_struct *fd_in);
...
struct fat_dir_struct* fat_open_dir(struct fat_fs_struct* fs, const struct fat_dir_entry_struct* dir_entry, struct fat_dir_struct *dd_in);
